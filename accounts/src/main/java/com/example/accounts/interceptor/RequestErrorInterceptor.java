package com.example.accounts.interceptor;
...
public class RequestErrorInterceptor implements WebGraphQlInterceptor {
    ...
    private GraphQLError createValidationError(ResponseError error) {
        ...
        }else if (error.getMessage().contains("is not a valid 'PositiveFloat'")){
            errorMessage = "Invalid Transfer Limit. Please use a positive number";
            extensionMap.put("Supported transferLimit", "Positive Amount");
        }
